...
void Host::determinePublic()
{
    ...
    {
    	LOGNETINF << "Public address set to Host configured address: " << paddr << ". UPnP disabled.";
        ep.address(paddr);
    }
...
void Host::startedWorking()
{
    ...
    if (port > 0)
    {
    	...
    	LOGHOSTDBG << "p2p.start.notice id: " << id() << " TCP Listen port is invalid or unavailable.";
